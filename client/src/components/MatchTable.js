...
class MatchTable extends Component
{
    ...
    render()
    {
        ...
        if(! Array.isArray( this.props.items))
        {
            ...
            throw Error("Props.items should contain a list of matches")

        }
        if(this.props.items.every((i) => i != undefined && i != null) == false)
        {

            throw new Error("props.data must be an instance of match")
        ...
        }) === false)
        {
            ...
            throw new Error("every piece of data should have valid date, home, away and comp name");
...
function MatchRow(props)
{
    ...
    if((props.data instanceof Match) == false)
    {

        throw Error("props.data must be an instance of match");
